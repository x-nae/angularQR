app.service('DataService', function ($http) {
    ...
    if (mock) {
        ...
        URL = {
            modelDetails: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/modelDetails.jsp',
            setModel: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/setModels.jsp',
            contractInfo: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/contractinfo.jsp',
            isEnabled: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/isenabled.jsp',
            enable: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/isenabled.jsp',
            disable: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/isenabled.jsp',
            on: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/isenabled.jsp',
            off: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/isenabled.jsp',
            timeLeft: '/x-one-proxy/proxy/mock/getData/x-mock/rest/mockServiceCommon/loadResponse/timeleft',
            getTrades: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/getTrades.jsp',
            ticks: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/ticks.jsp',
            tickUpdates: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/tickUpdate.jsp',
            history: '/x-one-proxy/proxy/mock/getData/x-mock/rest/qr_service/history.jsp',
            navHistory: '/x-one-proxy/proxy/mock/getData/x-mock/rest/mockServiceCommon/loadResponse/navHistory',
            navLatest: '/x-one-proxy/proxy/mock/getData/x-mock/rest/mockServiceCommon/loadResponse/nav.jsp',
            clients: '/x-one-proxy/proxy/mock/getData/x-mock/rest/mockServiceCommon/loadResponse/clients',
            accountSummary: '/x-one-proxy/proxy/trade/getData/x-trading/rest/trading/accountDetail',
